...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    transition={{duration: 0.6, ease: 'easeOut'}}
     ...
     className="flex items-center justify-between px-4 sm:px-8 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
      <img
