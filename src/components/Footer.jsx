...
const Footer = ({ theme }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-14 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40"
    >
      {/* footer top  */}
      <div
        ...
        viewport={{ once: true }}
         className="text-gray-600 dark:text-gray-400">
          ...
          <div className="flex gap-2">
            ...
            />
            <button className="bg-primary text-white rounded px-6 py-2 w-max">
              Subscribe
            </button>
          </div>
        </motion.div>
      ...
      viewport={{ once: true }}
      className="flex justify-between items-center gap-4 flex-wrap text-gray-500 pb-6 text-sm">
